	...
	<el-main class="flex justify-center items-center">
		<div class="w-full h-full flex justify-center items-center">
			<div
				...
				<el-form :model="form" :rules="rules" ref="formRef" label-width="100px" class="w-3/4" label-position="top"
				>
					...
					<div class="flex justify-center items-center mb-5">
						<el-input v-model="captchaInput" placeholder="input captcha" class="rounded rounded-2xl ml-10 pl-5 w-[130px] h-[2.80rem]" clearable />

						<img ref="captchaImg" alt="captcha" class="mx-3 rounded rounded-xl border border-solid border-dark-300" />
						<el-button @click="changeCaptcha" type="text"><el-icon size="30"><Refresh /></el-icon></el-button>
					</div>
					...
					<el-form-item class="flex justify-center mb-0 noml">
						<div class="w-full flex justify-center items-center">
							...
							<el-button type="primary" class="morandi-button mx-5" size="large" @click="onCancel">Cancel</el-button>
						</div>
					</el-form-item>
